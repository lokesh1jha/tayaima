          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                <a
                  href="https://www.facebook.com/tayaima"
                  target="_blank"
                ...
                <a
                  href="https://www.instagram.com/tayaima"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
              <div className="flex items-center gap-2">
                ...
                <a href="tel:+919768523325" className="hover:text-green-600 dark:hover:text-green-400 transition-colors">
                  +91 9768523325
                </a>
              </div>
              <div className="flex items-center gap-2">
                ...
                <a href="mailto:support@tayaima.com" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  support@tayaima.com
                </a>
              </div>
              <div className="flex items-center gap-2">
