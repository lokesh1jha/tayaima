...
export default function AdminAdminsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
        <Card className="p-4 sm:p-6">
          <div className="flex items-center justify-between">
            ...
            <div className="p-2 sm:p-3 bg-red-100 dark:bg-red-900 rounded-full flex-shrink-0 ml-3">
      ...
      {/* Admin List */}
      <Card className="p-4 sm:p-6">
        <h2 className="text-lg sm:text-xl font-semibold mb-4">All Admin Users</h2>
        ...
        {admins.length === 0 ? (
          ...
          <>
            ...
            <div className="lg:hidden space-y-4">
              {admins.map((admin) => (
                <div key={admin.id} className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 bg-gray-50 dark:bg-gray-800">
